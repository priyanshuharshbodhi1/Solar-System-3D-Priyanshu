# 3D 3D Solar System Simulator in THREE.js

Welcome to the **3D 3D Solar System Simulator** project, a dynamic and interactive simulation of our solar system created using THREE.js and the Vite framework. This project showcases various advanced features and effects to provide an immersive experience of the celestial bodies in our solar system.
...
- [3D Solar System Simulator Scope Textures](https://www.solarsystemscope.com/textures/)
...
4. Start the development server:
    ...
    npm run dev
    ```
5. Open your browser and navigate to `http://localhost:3000` to see the 3D 3D Solar System Simulator in action.
